...
def info(bot: Bot, update: Update, args: List[str]):
    ...
    if user.id == OWNER_ID:
            ...
            text += f'\nThe Nation level of this person is <a href="https://t.me/kigyorobot?start=nations">Kaali Union</a>'
            Nation_level_present = True
    elif user.id in SUDO_USERS:
            text += f'\nThe Nation level of this person is <a href="https://t.me/kigyorobot?start=nations">Lion</a>'
            Nation_level_present = True
    elif user.id in SUPPORT_USERS:
            text += f'\nThe Nation level of this person is <a href="https://t.me/kigyorobot?start=nations">Leopard</a>'
            Nation_level_present = True
    elif user.id in TIGER_USERS:
            text += f'\nThe Nation level of this person is <a href="https://t.me/kigyorobot?start=nations">Tiger</a>'
            Nation_level_present = True
    elif user.id in WHITELIST_USERS:
            text += f'\nThe Nation level of this person is <a href="https://t.me/kigyorobot?start=nations">Hyena</a>'
            Nation_level_present = True
