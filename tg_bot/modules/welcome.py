        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A member of the Kaali Union just joined!"
                )

            # Welcome Sudos
            elif new_mem.id in SUDO_USERS:
                update.effective_message.reply_text(
                    "Huh! A Lion Disaster just joined! Stay Alert!"
                )

            # Welcome Support
            elif new_mem.id in SUPPORT_USERS:
                update.effective_message.reply_text(
                    "Huh! Someone with a Leopard Disaster level just joined!"
                )
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text(
                    "Oof! A Hyena Disaster just joined!"
                )
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            # Give the devs a special goodbye
                ...
                update.effective_message.reply_text("See you later at the Kaali Union!")
                return
